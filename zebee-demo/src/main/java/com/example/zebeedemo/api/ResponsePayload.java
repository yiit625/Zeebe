package com.example.zebeedemo.api;
...
public class ResponsePayload {
    ...
    public ResponsePayload(String successfulCode, String successfulMessage, Object data) {
    }


    public static ResponsePayload success(Object data) {
        return new ResponsePayload(SUCCESSFUL_CODE, SUCCESSFUL_MESSAGE, data);
    }
    ...
    public ResponsePayload(String lang) {
    }
